...
/datum/sprite_accessory/tail/taur/teppi			// Mostly used as example/template/test subject as to how you use the 'big' taur sprites. Pls give it better icons before uncommenting... //Re-adding anyway - ArrhythmiaV
>>>>>>> 27c8a54f523bf9e229af95a365d210d40f92a187
	name = "Teppi (Taur)"
	icon_state = "teppi_s"
